...
class InterplaneterUIApp(MDApp):
    ...
    def build(self):
        ...
        self.image = Image(source="src/basic/images/erc_guiback_1.png", size_hint = (1.,1.), pos_hint={'center_x': 0.5, 'center_y': 0.5}, allow_stretch = 1,keep_ratio=0)
        ...
        self.cam_text = Label(text='Camera Feed', pos_hint={'center_x': .26, 'center_y': .95}, size_hint=(0.4,0.4),font_size = 30)
        ...
        self.arm_text = Label(text='-----  Arm Controls  -----', pos_hint={'center_x': .74, 'center_y': .95}, size_hint=(0.4,0.4),font_size = 30)
        ...
        self.image_feed = Image(size_hint = (0.6,0.6), pos_hint = {"center_x": 0.26,"center_y": 0.625}, allow_stretch = 1)
        ...
        self.base = Slider(min=0, max=360, value=0, step=1, orientation='horizontal', size_hint = (0.15,0.025), pos_hint = {"center_x": 0.71,"center_y": 0.65})
        self.base.bind(value=self.move_base)
        layout.add_widget(self.base)
        self.base_val = Label(text='0', pos_hint={'center_x': .795, 'center_y': .65}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.base_val)
        self.base_text = Label(text='Base', pos_hint={'center_x': .835, 'center_y': .65}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.base_text)
        self.base_targ = Label(text='X', pos_hint={'center_x': .875, 'center_y': .65}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.base_targ)
        self.base_set_button = MDRaisedButton(text="Track", pos_hint={'center_x': .61, 'center_y': .65}, size_hint=(0.01,0.03),font_size = 20)
        self.base_set_button.bind(on_press=self.base_set)
        layout.add_widget(self.base_set_button)
        self.base_left_button = MDRaisedButton(text="<-", pos_hint={'center_x': .925, 'center_y': .65}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.base_right_button = MDRaisedButton(text="->", pos_hint={'center_x': .975, 'center_y': .65}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.shoulder = Slider(min=0, max=180, value=0, step=1, orientation='horizontal', size_hint = (0.15,0.025), pos_hint = {"center_x": 0.71,"center_y": 0.7})
        self.shoulder.bind(value=self.move_shoulder)
        layout.add_widget(self.shoulder)
        self.shoulder_val = Label(text='0', pos_hint={'center_x': .795, 'center_y': .7}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.shoulder_val)
        self.shoulder_text = Label(text='Shoulder', pos_hint={'center_x': .835, 'center_y': .7}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.shoulder_text)
        self.shoulder_targ = Label(text='X', pos_hint={'center_x': .875, 'center_y': .7}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.shoulder_targ)
        self.shoulder_set_button = MDRaisedButton(text="Track", pos_hint={'center_x': .61, 'center_y': .7}, size_hint=(0.01,0.03),font_size = 20)
        self.shoulder_set_button.bind(on_press=self.shoulder_set)
        layout.add_widget(self.shoulder_set_button)
        self.shoulder_left_button = MDRaisedButton(text="<-", pos_hint={'center_x': .925, 'center_y': .7}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.shoulder_right_button = MDRaisedButton(text="->", pos_hint={'center_x': .975, 'center_y': .7}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.elbow = Slider(min=0, max=180, value=0, step=1, orientation='horizontal', size_hint = (0.15,0.025), pos_hint = {"center_x": 0.71,"center_y": 0.75})
        self.elbow.bind(value=self.move_elbow)
        layout.add_widget(self.elbow)
        self.elbow_val = Label(text='0', pos_hint={'center_x': .795, 'center_y': .75}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.elbow_val)
        self.elbow_text = Label(text='Elbow', pos_hint={'center_x': .835, 'center_y': .75}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.elbow_text)
        self.elbow_targ = Label(text='X', pos_hint={'center_x': .875, 'center_y': .75}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.elbow_targ)
        self.elbow_set_button = MDRaisedButton(text="Track", pos_hint={'center_x': .61, 'center_y': .75}, size_hint=(0.01,0.03),font_size = 20)
        self.elbow_set_button.bind(on_press=self.elbow_set)
        layout.add_widget(self.elbow_set_button)
        self.elbow_left_button = MDRaisedButton(text="<-", pos_hint={'center_x': .925, 'center_y': .75}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.elbow_right_button = MDRaisedButton(text="->", pos_hint={'center_x': .975, 'center_y': .75}, size_hint=(0.01,0.03),font_size = 20)
        ...
        self.pitch = Slider(min=0, max=270, value=0, step=1, orientation='horizontal', size_hint = (0.15,0.025), pos_hint = {"center_x": 0.71,"center_y": 0.8})
        self.pitch.bind(value=self.move_pitch)
        layout.add_widget(self.pitch)
        self.pitch_val = Label(text='0', pos_hint={'center_x': .795, 'center_y': .8}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.pitch_val)
        self.pitch_text = Label(text='Pitch', pos_hint={'center_x': .835, 'center_y': .8}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.pitch_text)
        self.pitch_targ = Label(text='X', pos_hint={'center_x': .875, 'center_y': .8}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.pitch_targ)

        self.yaw = Slider(min=0, max=270, value=0, step=1, orientation='horizontal', size_hint = (0.15,0.025), pos_hint = {"center_x": 0.71,"center_y": 0.85})
        self.yaw.bind(value=self.move_yaw)
        layout.add_widget(self.yaw)
        self.yaw_val = Label(text='0', pos_hint={'center_x': .795, 'center_y': .85}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.yaw_val)
        self.yaw_text = Label(text='Yaw', pos_hint={'center_x': .835, 'center_y': .85}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.yaw_text)
        self.yaw_targ = Label(text='X', pos_hint={'center_x': .875, 'center_y': .85}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.yaw_targ)

        self.roll_cw_button = MDRaisedButton(text="Roll CW", pos_hint={'center_x': .71, 'center_y': .9}, size_hint=(0.05,0.05),font_size = 20)
        ...
        self.roll_ccw_button = MDRaisedButton(text="Roll CCW", pos_hint={'center_x': .65, 'center_y': .9}, size_hint=(0.05,0.05),font_size = 20)
        ...
        self.grip_open_button = MDRaisedButton(text="Grip Open", pos_hint={'center_x': .77, 'center_y': .9}, size_hint=(0.05,0.05),font_size = 20)
        ...
        self.grip_close_button = MDRaisedButton(text="Grip Close", pos_hint={'center_x': .83, 'center_y': .9}, size_hint=(0.05,0.05),font_size = 20)
        ...
        self.press_a_button = MDRaisedButton(text="Press A", pos_hint={'center_x': .89, 'center_y': .92}, size_hint=(0.025,0.025),font_size = 15)
        ...
        self.press_b_button = MDRaisedButton(text="Press B", pos_hint={'center_x': .89, 'center_y': .88}, size_hint=(0.025,0.025),font_size = 15)
        ...
        self.screw_cw_button = MDRaisedButton(text="Screw CW", pos_hint={'center_x': .59, 'center_y': .92}, size_hint=(0.025,0.025),font_size = 15)
        ...
        self.screw_ccw_button = MDRaisedButton(text="Screw CCW", pos_hint={'center_x': .59, 'center_y': .88}, size_hint=(0.025,0.025),font_size = 15)
        ...
        self.activate_arm = Slider(min=0, max=1, value=0, step=1, orientation='horizontal', size_hint = (0.05,0.05), pos_hint = {"center_x": 0.95,"center_y": 0.9})
        self.activate_arm.bind(value=self.activate_arm_on_value)
        layout.add_widget(self.activate_arm)
        self.activate_arm_val = Label(text='Locked', pos_hint={'center_x': .95, 'center_y': .87}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.activate_arm_val)
        self.activate_arm_text = Label(text='Activate Arm', pos_hint={'center_x': .95, 'center_y': .93}, size_hint=(0.4,0.4),font_size = 20)
        layout.add_widget(self.activate_arm_text)

        self.mux_val = Label(text='X', pos_hint={'center_x': .95, 'center_y': .8}, size_hint=(0.4,0.4),font_size = 15)
        layout.add_widget(self.mux_val)
        self.mux_text = Label(text='MUX', pos_hint={'center_x': .95, 'center_y': .825}, size_hint=(0.4,0.4),font_size = 15)
        layout.add_widget(self.mux_text)


        

        self.arm_info = Label(text='Press F for Emergency Stop. Activate the Arm before pushing buttons and pulling sliders', pos_hint={'center_x': .79, 'center_y': .525}, size_hint=(0.4,0.4),font_size = 15)
        ...
        for i in range(6):
            self.pump_button = MDRaisedButton(text="Pump "+str(int(i+1)), pos_hint={'center_x': .0925+i*0.07, 'center_y': .260}, size_hint=(0.06,0.08),font_size = 20)
        ...
        for i in range(2):
            for j in range(2):
                self.motor_button = MDRaisedButton(text=rails[i]+direction[j], pos_hint={'center_x': .1125+j*0.1+i*0.21, 'center_y': .160}, size_hint=(0.09,0.08),font_size = 20)
        ...
        #self.drill_down_button = MDRaisedButton(text="S1 Down", pos_hint={'center_x': .175, 'center_y': .150}, size_hint=(0.05,0.05),font_size = 20)
        ...
        #self.drill_up_button = MDRaisedButton(text="S2 Up", pos_hint={'center_x': .23, 'center_y': .150}, size_hint=(0.05,0.05),font_size = 20)
        ...
        #self.drill_cw_button = MDRaisedButton(text="S1 Down", pos_hint={'center_x': .285, 'center_y': .150}, size_hint=(0.05,0.05),font_size = 20)
        ...
        #self.drill_ccw_button = MDRaisedButton(text="S2 Up", pos_hint={'center_x': .34, 'center_y': .150}, size_hint=(0.05,0.05),font_size = 20)
        ...
        #self.rc_spin_button = MDRaisedButton(text="Spinning", pos_hint={'center_x': .42, 'center_y': .250}, size_hint=(0.05,0.05),font_size = 20)
        ...
        #self.rc_step_button = MDRaisedButton(text="Stepping", pos_hint={'center_x': .48, 'center_y': .25}, size_hint=(0.05,0.05),font_size = 20)
    ...
    def pump(self, i,*args):
        self.command = 'P'+str(int(i+1))
        sci_pub.publish(self.command)
    def pump_stop(self, i,*args):
        self.command = 'P'+str(int(i+1+6))
        sci_pub.publish(self.command)
