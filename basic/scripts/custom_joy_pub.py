...
cmdx_r = ["B400","E400","S400"]
cmdx_l = ["B500","E500","S500"]
...
def callback(data):
    ...
    if data.axes[myjoy["NS"]]>0. && oldp>plim[0]:
        oldp -= 1
        flagp = True
    elif data.axes[myjoy["NS"]]<0. && oldp<plim[1]:
        oldp += 1
        flagp = True
    else:
        flagp = False
    ...
    if data.axes[myjoy["EW"]]>0. && oldy>ylim[0]:
        oldy -= 1
        flagy = True
    elif data.axes[myjoy["EW"]]<0. && oldy<ylim[1]:
        oldy += 1
        flagy = True
    else:
        flagy = False
